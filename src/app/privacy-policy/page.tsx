    ...
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '4rem 2rem', fontFamily: 'system-ui, -apple-system, sans-serif', lineHeight: 1.6, color: '#1e293b' }}>
      ...
      <section style={{ marginBottom: '2rem' }}>
        ...
        <p style={{ marginBottom: '1rem' }}>
          O aplicativo <strong>Gerência de leads CRM</strong> (acessível através do site mkt.ciasuper.com.br, doravante denominado "nós", "nosso" ou "Gerency Leads") respeita a sua privacidade e está comprometido em proteger as suas informações pessoais. 
