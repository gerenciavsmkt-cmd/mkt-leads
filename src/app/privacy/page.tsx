      ...
      <div style={{ 
        ...
        <div style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.1)', paddingBottom: '2rem', marginBottom: '2.5rem' }}>
          ...
          <p style={{ color: 'rgba(255, 255, 255, 0.5)', fontSize: '0.9375rem' }}>
            Aplicativo: <strong style={{ color: '#3b82f6' }}>Gerency Leads</strong> (acessível em <a href="https://mkt.ciasuper.com.br" style={{ color: '#3b82f6', textDecoration: 'none' }}>mkt.ciasuper.com.br</a>)
          </p>
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <p style={{ marginBottom: '1rem' }}>
            O aplicativo <strong>Gerency Leads</strong> (operado no domínio <strong>mkt.ciasuper.com.br</strong>) está totalmente comprometido com a segurança e a proteção da privacidade dos seus usuários.
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <p style={{ marginBottom: '1.1rem' }}>
            Para habilitar os recursos de CRM de atendimento, sincronização e respostas em tempo real, o aplicativo <strong>Gerency Leads</strong> solicita permissões específicas das plataformas parceiras. Especificamente em relação à sua conta de rede social conectada, coletamos:
          </p>
          <ul style={{ listStyleType: 'disc', paddingLeft: '1.75rem', marginBottom: '1rem', display: 'grid', gap: '0.75rem' }}>
            <li>
              <strong style={{ color: '#ffffff' }}>Informações Básicas do Perfil (escopo user.info.basic):</strong> Usamos o nome de usuário público, imagem de perfil e identificador único da conta para personalizar sua interface no painel administrativo do <strong>Gerency Leads</strong> e identificar de qual conta os dados são provenientes.
            </li>
            <li>
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <p style={{ marginBottom: '1rem' }}>
            Todas as informações obtidas são processadas exclusivamente para viabilizar as funcionalidades da plataforma de CRM do <strong>Gerency Leads</strong>, que consistem em:
          </p>
          ...
          <p style={{ marginTop: '1rem', padding: '1rem', background: 'rgba(59, 130, 246, 0.1)', borderLeft: '4px solid #3b82f6', borderRadius: '8px', color: '#93c5fd' }}>
            <strong>Garantia de Privacidade:</strong> O <strong>Gerency Leads</strong> não comercializa, não aluga e não compartilha dados de usuários ou de leads com terceiros para fins publicitários ou lucrativos. Os dados são usados exclusivamente para a execução do serviço contratado.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <p style={{ marginBottom: '1rem' }}>
            ...
            Esses dados permanecem armazenados apenas enquanto a conta do usuário estiver ativa e a integração correspondente estiver autorizada.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <p style={{ marginBottom: '1rem' }}>
            Você possui controle total sobre suas conexões no <strong>Gerency Leads</strong>. A qualquer momento, você pode:
          </p>
          <ul style={{ listStyleType: 'disc', paddingLeft: '1.75rem', marginBottom: '1rem', display: 'grid', gap: '0.5rem' }}>
        ...
        <section style={{ borderTop: '1px solid rgba(255, 255, 255, 0.1)', paddingTop: '2rem', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem', fontSize: '0.875rem', opacity: 0.7 }}>
          <span>© {new Date().getFullYear()} Gerency Leads. Todos os direitos reservados.</span>
